...
_react2['default'].render(_react2['default'].createElement(_clientApp2['default'], null), global.document.getElementById('content'));


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./client/app":3,"react":168}],2:[function(require,module,exports){
module.exports = {"container":"_client_app__container","input":"_client_app__input"}
...
var _result_set_list = require('./result_set_list');

var _result_set_list2 = _interopRequireDefault(_result_set_list);
...
},{"./app.css":2,"./result_set_list":12,"react":168,"reqwest":169}],4:[function(require,module,exports){
module.exports = {"filter":"_client_filter__filter _client_result_set__result _client_styles__walmart","facetGrid":"_client_filter__facetGrid _client_styles__clearfix","facetContainer":"_client_filter__facetContainer _client_styles__clearfix","facet":"_client_filter__facet _client_styles__walmart _client_styles__clickable _client_styles__clearfix","filterHeader":"_client_filter__filterHeader","facetCount":"_client_filter__facetCount","facetImage":"_client_filter__facetImage","facetText":"_client_filter__facetText"}
...
var _filterCss = require('./filter.css');

var _filterCss2 = _interopRequireDefault(_filterCss);

var _link = require('./link');

var _link2 = _interopRequireDefault(_link);

var _lookup_image = require('./lookup_image');

var _lookup_image2 = _interopRequireDefault(_lookup_image);
...
var Filter = (function (_React$Component) {
  ...
  _createClass(Filter, [{
    ...
    value: function render() {
      return _react2['default'].createElement(
        'div',
        { className: _filterCss2['default'].filter },
        _react2['default'].createElement(
          'div',
          { className: _filterCss2['default'].filterHeader },
          'by ',
          this.props.displayName
        ),
        _react2['default'].createElement(
          'div',
          { className: _filterCss2['default'].facetGrid },
          this._renderFacets()
        )
      );
    }
    ...
    key: '_renderFacet',
    value: function _renderFacet(facet, index) {
    ...
    key: '_renderFacetWithImage',
    value: function _renderFacetWithImage(facet, index) {
      return _react2['default'].createElement(
        'div',
        { className: _filterCss2['default'].facetContainer, key: index },
        _react2['default'].createElement(
          _link2['default'],
          { className: _filterCss2['default'].facet, href: facet.url },
          _react2['default'].createElement('img', {
            src: (0, _lookup_image2['default'])(this.props.name, facet.name),
            className: _filterCss2['default'].facetImage
          }),
          _react2['default'].createElement(
            'div',
            { className: _filterCss2['default'].facetText },
            _react2['default'].createElement(
              'div',
              null,
              facet.name
            ...
            _react2['default'].createElement(
              'div',
              { className: _filterCss2['default'].facetCount },
              facet.count,
              ' results'
            )
          )
    ...
    key: '_renderFacetWithoutImage',
    value: function _renderFacetWithoutImage(facet, index) {
      return _react2['default'].createElement(
        'div',
        { className: _filterCss2['default'].facetContainer, key: index },
        _react2['default'].createElement(
    ...
    key: '_wantImage',
    value: function _wantImage(filterName) {
      var lookup = CATEGORY_MAP[this.props.categoryName];
...
},{"./filter.css":4,"./link":7,"./lookup_image":8,"react":168}],6:[function(require,module,exports){
'use strict';
...
var FilterList = (function (_React$Component) {
  ...
  _createClass(FilterList, [{
    key: 'render',
    value: function render() {
      var filters = this.props.filters.filter(function (filter) {
      ...
      return _react2['default'].createElement(
        'div',
        null,
        filters.map(this._renderFilter)
      );
    }
  }, {
    key: '_renderFilter',
    value: function _renderFilter(filter, index) {
      return _react2['default'].createElement(_filter2['default'], _extends({ categoryName: this.props.categoryName }, filter, { key: index }));
    }
  }]);
...
},{"./filter":5,"react":168}],7:[function(require,module,exports){
'use strict';
...
var Link = (function (_React$Component) {
  ...
  _createClass(Link, [{
    key: 'render',
    value: function render() {
      var myTarget = document.domain.indexOf('walmart') >= 0 ? null : '_blank';
      return _react2['default'].createElement(
        'a',
        _extends({}, this.props, { target: myTarget }),
        this.props.children
      );
    }
  }]);
...
exports['default'] = lookupImage;

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var _sharedUtilsSlugify = require('../shared/utils/slugify');

var _sharedUtilsSlugify2 = _interopRequireDefault(_sharedUtilsSlugify);

var PREFIX = 'http://localhost:3000/images/facets';

function lookupImage(filterName, facetName) {
  var extension = filterName === 'color' ? 'png' : 'webp';
  return PREFIX + '/' + (0, _sharedUtilsSlugify2['default'])(filterName) + '/' + (0, _sharedUtilsSlugify2['default'])(facetName) + '.' + extension;
}

module.exports = exports['default'];


},{"../shared/utils/slugify":170}],9:[function(require,module,exports){
module.exports = {"result":"_client_result_set__result _client_styles__walmart","parentResult":"_client_result_set__parentResult _client_result_set__result _client_styles__walmart _client_styles__clickable","childResult":"_client_result_set__childResult _client_result_set__result _client_styles__walmart _client_styles__clickable","path":"_client_result_set__path","resultSet":"_client_result_set__resultSet"}
...
var _result_setCss = require('./result_set.css');

var _result_setCss2 = _interopRequireDefault(_result_setCss);

var _link = require('./link');

var _link2 = _interopRequireDefault(_link);

var ResultSet = (function (_React$Component) {
  _inherits(ResultSet, _React$Component);

  function ResultSet(props) {
    _classCallCheck(this, ResultSet);

    _get(Object.getPrototypeOf(ResultSet.prototype), 'constructor', this).call(this, props);
  ...
  _createClass(ResultSet, [{
    ...
    value: function render() {
      return _react2['default'].createElement(
        'div',
        { className: _result_setCss2['default'].resultSet },
    ...
    key: '_renderParentResult',
    value: function _renderParentResult() {
      var parentResult = this.props.parentResult;
      return _react2['default'].createElement(
        _link2['default'],
        { className: _result_setCss2['default'].parentResult, href: parentResult.url },
    ...
    key: '_renderPath',
    value: function _renderPath(path) {
      if (!path) {
        return null;
      }
      return _react2['default'].createElement(
        'div',
        { className: _result_setCss2['default'].path },
        'in ',
        path
      );
    }
  }, {
    key: '_renderChildResultList',
    value: function _renderChildResultList() {
    ...
    key: '_renderFilters',
    value: function _renderFilters(filters) {
      if (!filters || filters.length <= 0) {
        return null;
      }
      return _react2['default'].createElement(_filter_list2['default'], {
        categoryName: this.props.parentResult.displayText,
        filters: filters
      });
    }
  }, {
    key: '_renderChildResult',
    value: function _renderChildResult(result, index) {
      return _react2['default'].createElement(
        _link2['default'],
        { className: _result_setCss2['default'].childResult, key: index, href: result.url },
        result.displayText
      );
    }
  }]);
...
},{"./filter_list":6,"./link":7,"./result_set.css":9,"react":168}],11:[function(require,module,exports){
module.exports = {"resultSetList":"_client_result_set_list__resultSetList"}
...
var _result_set = require('./result_set');

var _result_set2 = _interopRequireDefault(_result_set);

var _result_set_listCss = require('./result_set_list.css');

var _result_set_listCss2 = _interopRequireDefault(_result_set_listCss);

var ResultSetList = (function (_React$Component) {
  _inherits(ResultSetList, _React$Component);

  function ResultSetList() {
    _classCallCheck(this, ResultSetList);

    _get(Object.getPrototypeOf(ResultSetList.prototype), 'constructor', this).apply(this, arguments);
  }

  _createClass(ResultSetList, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement(
        'div',
        { className: _result_set_listCss2['default'].resultSetList },
        this.props.resultSets.slice(0, 5).map(this._renderResultSet)
      );
    }
  }, {
    key: '_renderResultSet',
    value: function _renderResultSet(resultSet, index) {
      return _react2['default'].createElement(_result_set2['default'], _extends({}, resultSet, { key: index }));
    }
  }]);
...
exports['default'] = ResultSetList;
module.exports = exports['default'];


},{"./result_set":10,"./result_set_list.css":11,"react":168}],13:[function(require,module,exports){
